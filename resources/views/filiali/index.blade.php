                    ...
                    <table class="table table-hover table-striped">
                        ...
                        <tbody>
                            @foreach ($filiali as $filiale)
                                <tr>
                                    <td class="table-text"><div>{{ $filiale->id }}</div></td>
                                    <td class="table-text"><div>{{ $filiale->nome }}</div></td>
                                    <td class="table-text"><div>{{ $filiale->indirizzo }}</div></td>
                                    <td class="table-text"><div>{{ $filiale->telefono }}</div></td>
