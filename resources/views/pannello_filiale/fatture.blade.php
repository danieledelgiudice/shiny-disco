        ...
        <table class="table table-hover table-striped">
            ...
            <tbody>
                @foreach ($fattureElys as $fattura)
                    <tr class="">
                        <td class="table-text"><div>{{ appartenenza_fatture($fattura->appartenenza) }}</div></td>
...
<div class="panel panel-default">
    <div class="panel-body">
        <!-- Lista fatture Ely's/Elisir Group -->
        <h4>Fatture Ely's Elisir Group</h4>
        <table class="table table-hover table-striped">
            <thead>
                <th>Filiale</th>
                <th>Numero fattura</th>
            ...
            <tbody>
                @foreach ($fattureGroup as $fattura)
                    <tr class="">
                        <td class="table-text"><div>{{ appartenenza_fatture($fattura->appartenenza) }}</div></td>
                        <td class="table-text"><div>{{ $fattura->numero }}</div></td>
                        <td class="table-text">
                ...
                <tr class="row-subtotal orange">
                    ...
                    <th></th>
                    <th></th>
                    <th>{{ format_money($fattureGroup->sum('importo_netto')) }}</th>
                    <th>{{ format_money($fattureGroup->sum('importo_esente')) }}</th>
                    <th>{{ format_money($fattureGroup->sum('lordo_incassato')) }}</th>
                    <th></th>
                    <th>&nbsp;</th>
                </tr>
            </tbody>
