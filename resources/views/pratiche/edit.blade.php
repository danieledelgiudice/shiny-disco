                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="input-group date">
                                {!! Form::text('data_apertura', format_date($pratica->data_apertura), ['class' => 'form-control date-control']) !!}
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="input-group date">
                                {!! Form::text('in_data', format_date($pratica->in_data), ['class' => 'form-control date-control']) !!}
                                <span class="input-group-addon"><i class="fa fa-fw fa-calendar"></i></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="input-group date">
                                {!! Form::text('data_ultima_lettera', format_date($pratica->data_ultima_lettera), ['class' => 'form-control date-control']) !!}
                                <span class="input-group-addon"><i class="fa fa-fw fa-calendar"></i></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="input-group date">
                                {!! Form::text('data_chiusura', format_date($pratica->data_chiusura), ['class' => 'form-control date-control']) !!}
                                <span class="input-group-addon"><i class="fa fa-fw fa-calendar"></i></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="input-group date">
                                {!! Form::text('data_sospeso', format_date($pratica->data_sospeso), ['class' => 'form-control date-control']) !!}
                                <span class="input-group-addon"><i class="fa fa-fw fa-calendar"></i></span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="input-group date">
                                {!! Form::text('data_sinistro', format_date($pratica->data_sinistro), ['class' => 'form-control date-control']) !!}
                                <span class="input-group-addon"><i class="fa fa-fw fa-calendar"></i></span>
                            </div>
                        </div>
