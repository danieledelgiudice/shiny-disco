...
@section('content')
    <div class="container">
        <h1 class="page-header text-center">Modifica Pratica</h1>
        <div class="">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                {!! Form::text('data_apertura', null, ['class' => 'form-control']) !!}
                            </div>
                            
                            <!-- Stato pratica -->
                            {!! Form::label('stato_pratica', 'Stato pratica' , ['class' => 'col-md-2 control-label']) !!}
                            <div class="col-md-4">
                                {!! Form::text('stato_pratica', null, ['class' => 'form-control']) !!}
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                {{ Form::select('tipo_pratica', [], null, ['class' => 'form-control']) }}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                {!! Form::text('in_data', null, ['class' => 'form-control']) !!}
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                {!! Form::text('controllato', null, ['class' => 'form-control']) !!}
                            </div>
                            
                            <!-- Data ultima lettera -->
                            {!! Form::label('data_ultima_lettera', 'Data ultima lettera' , ['class' => 'col-md-2 control-label']) !!}
                            <div class="col-md-4">
                                {!! Form::text('data_ultima_lettera', null, ['class' => 'form-control']) !!}
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                {!! Form::text('rilievi', null, ['class' => 'form-control']) !!}
                            </div>
                        
                            <!-- Data chiusura -->
                            {!! Form::label('data_chiusura', 'Data chiusura' , ['class' => 'col-md-2 control-label']) !!}
                            <div class="col-md-4">
                                {!! Form::text('data_chiusura', null, ['class' => 'form-control']) !!}
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                {!! Form::text('importo_sospeso', null, ['class' => 'form-control']) !!}
                            </div>
                        
                            <!-- Data sospeso -->
                            {!! Form::label('data_sospeso', 'Data sospeso' , ['class' => 'col-md-2 control-label']) !!}
                            <div class="col-md-4">
                                {!! Form::text('data_sospeso', null, ['class' => 'form-control']) !!}
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                {!! Form::text('stato_avanzamento', null, ['class' => 'form-control']) !!}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                {!! Form::text('data_sinistro', null, ['class' => 'form-control']) !!}
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                {!! Form::text('autorita', null, ['class' => 'form-control']) !!}
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                {!! Form::text('rivalsa', null, ['class' => 'form-control']) !!}
                            </div>
                        
                            <!-- Soccorso -->
                            {!! Form::label('soccorso', 'Soccorso' , ['class' => 'col-md-2 control-label']) !!}
                            <div class="col-md-4">
                                {!! Form::text('soccorso', null, ['class' => 'form-control']) !!}
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                {!! Form::text('danno_presunto', null, ['class' => 'form-control']) !!}
                            </div>
                        </div>
