...
class DelegaGenerator
{
    ...
    public function generate($data)
    {
        ...
        $str = "Io sottoscritto {$cliente['nome']} {$cliente['cognome']} nato a {$cliente['citta_nascita']} il {$data_nascita} e residente in ${cliente['via']}, ${cliente['citta_residenza']}, delego lo studio Ely'S Consulenze sito in Via Claudio Cogorano 25, 5° piano - 57123 Livorno a ritirare copia dei verbali redatti per il sinistro da me subito in data ${data_sinistro}.";
